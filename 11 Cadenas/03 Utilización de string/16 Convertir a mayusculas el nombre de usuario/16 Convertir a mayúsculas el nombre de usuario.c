/* Problema 16. Pedir al usuario su nombre, apellido y ciudad en la que vive, posteriormente convertir todo a mayusculas
 * e imprimir los datos. (Utilizar una estructura). */
